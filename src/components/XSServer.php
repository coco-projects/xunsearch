<?php
    ...
    namespace Coco\xunsearch\components;
...
class XSServer extends XSComponent
{
     ...
     */
    public function reopen($force = false): static
    {
     ...
     */
    public function setProject($name, $home = ''): static
    {
     ...
     */
    public function setTimeout($sec): static
    {
        $cmd = [
            'cmd' => XS_CMD_TIMEOUT,
            'arg' => $sec,
     ...
     */
    public function sendCommand($cmd): static
    {
        if (!$cmd instanceof XSCommand) {
            $cmd = new XSCommand($cmd);
        }
     ...
     * @throw XSException 失败时抛出异常
     */
    public function getRespond(): XSCommand
    {
     ...
     */
    public function hasRespond(): bool
    {
        // check socket
     ...
     * @throw XSException 失败时抛出异常
     */
    protected function write($buf, $len = 0): bool|static
    {
     ...
     * @throw XSException 失败时抛出异常
     */
    protected function read($len): string
    {
